...
CCubeMeshDiffused::CCubeMeshDiffused(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, float fWidth, float fHeight, float fDepth) : CMesh(pd3dDevice, pd3dCommandList)
{
	...
	pVertices[0] = CDiffusedVertex(XMFLOAT3(-fx, +fy, -fz), { 0,0,0,1 });
	pVertices[1] = CDiffusedVertex(XMFLOAT3(+fx, +fy, -fz), { 0,0,0,1 });
	pVertices[2] = CDiffusedVertex(XMFLOAT3(+fx, +fy, +fz), { 0,0,0,1 });
	pVertices[3] = CDiffusedVertex(XMFLOAT3(-fx, +fy, +fz), { 0,0,0,1 });
	pVertices[4] = CDiffusedVertex(XMFLOAT3(-fx, -fy, -fz), { 0,0,0,1 });
	pVertices[5] = CDiffusedVertex(XMFLOAT3(+fx, -fy, -fz), { 0,0,0,1 });
	pVertices[6] = CDiffusedVertex(XMFLOAT3(+fx, -fy, +fz), { 0,0,0,1 });
	pVertices[7] = CDiffusedVertex(XMFLOAT3(-fx, -fy, +fz), { 0,0,0,1 });
	m_pd3dVertexBuffer = 
